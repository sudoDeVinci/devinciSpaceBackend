(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class g{#t={};on(t,e){this.#t[t]||(this.#t[t]=[]),this.#t[t].push(e)}emit(t,e){this.#t[t]&&this.#t[t].forEach(i=>i(e))}}class r extends g{#t;constructor(t,e){super(),this.#t=e,this.id=t,this.width=this.#t.width,this.height=this.#t.height,this.title=this.#t.title,this.content=this.#t.content,this.zIndex=this.#t.zIndex||1,this.isMinimized=e.isMinimized||!1,this.icon=e.icon||null,this.isDragging=!1,this.isResizing=!1,this.initialX=0,this.initialY=0,this.initialMouseX=0,this.initialMouseY=0,this.x=e.x||Math.min(Math.max(0,Math.random()*(window.innerWidth-this.width-100)),window.innerWidth-this.width),this.y=e.y||Math.min(Math.max(100,Math.random()*(window.innerHeight-this.height)-100),window.innerHeight-this.height),this.#e(),this.isMinimized&&this.minimize(),window.addEventListener("resize",this.handleResize.bind(this)),this.createResizeHandles()}#e(){this.element=document.createElement("div"),this.element.className="window",this.element.style.position="fixed",this.element.style.left=`${this.x}px`,this.element.style.top=`${this.y}px`,this.element.style.width=`${this.width}px`,this.element.style.height=`${this.height}px`,this.element.style.overflow="hidden",this.titleBar=document.createElement("div"),this.titleBar.className="window-title-bar title-bar",this.titleBar.style.cursor="move",this.titleBar.style.userSelect="none",this.titleBar.style.display="flex",this.titleBar.style.justifyContent="space-between",this.titleBar.style.padding="5px 8px",this.titleBar.style.alignItems="center",this.titleText=document.createElement("div"),this.titleText.className="window-title-bar-text title-bar-text",this.titleText.textContent=this.title,this.titleText.style.fontSize=this.#t.styles.titlebar_fontsize||"12px",this.titleBar.appendChild(this.titleText);const t=document.createElement("div");t.className="title-bar-controls",t.style.display="flex",this.minimizeButton=document.createElement("button"),this.minimizeButton.className="window-minimize-button",this.minimizeButton.ariaLabel="Minimize",this.minimizeButton.onclick=e=>{e.stopPropagation(),this.toggleMinimize()},t.appendChild(this.minimizeButton),this.closeButton=document.createElement("button"),this.closeButton.className="window-close-button",this.closeButton.ariaLabel="Close",this.closeButton.onclick=e=>{e.stopPropagation(),this.emit("close",this)},t.appendChild(this.closeButton),this.titleBar.appendChild(t),this.contentArea=document.createElement("div"),this.contentArea.className="window-content window-body",this.contentArea.innerHTML=this.content,this.titleBar.onmousedown=e=>{e.preventDefault(),this.startDrag(e)},this.element.appendChild(this.titleBar),this.element.appendChild(this.contentArea),this.element.onclick=()=>this.emit("focus",this)}createResizeHandles(){[{cursor:"nwse-resize",position:"top-left",dx:-1,dy:-1},{cursor:"nesw-resize",position:"top-right",dx:1,dy:-1},{cursor:"nesw-resize",position:"bottom-left",dx:-1,dy:1},{cursor:"nwse-resize",position:"bottom-right",dx:1,dy:1}].forEach(e=>{const i=document.createElement("div");switch(i.className=`resize-handle resize-${e.position}`,i.style.cssText=`
    ...
    `;const s=document.createElement("div");s.className="message-sender",s.style.cssText=`
      ...
      margin-bottom: 4px;
      color: #666;
    `,s.textContent=t.username,e.appendChild(s);const n=document.createElement("div");this.parseMessageContent(t.data).forEach(c=>{const l=document.createElement("div");c.type==="code"?l.style.cssText=`
    ...
    `,e.appendChild(i),t.appendChild(e),Object.entries(this.categories).forEach(([s,n])=>{const o=document.createElement("div");o.className="emoji-category",o.style.marginBottom="20px";const a=document.createElement("h3");a.textContent=s,a.style.cssText=`
      ...
      `,n.forEach(l=>{const d=document.createElement("button");d.textContent=l,d.style.cssText=`
        ...
        `,d.onclick=()=>{this.emit("emojiSelected",{emoji:l})},c.appendChild(d)}),o.appendChild(a),o.appendChild(c),t.appendChild(o),i.focus()}),i.oninput=s=>{const n=s.target.value.toLowerCase();t.querySelectorAll(".emoji-category").forEach(a=>{const c=a.querySelectorAll("button");let l=!1;c.forEach(d=>{const m=d.textContent.toLowerCase().includes(n);d.style.display=m?"block":"none",m&&(l=!0)}),a.style.display=l?"block":"none"})},this.contentArea.appendChild(t)}}class y{constructor(){this.listeners={}}on(t,e){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(e)}emit(t,e){this.listeners[t]&&this.listeners[t].forEach(i=>i(e))}}class f extends y{#t=null;#e=0;#s=0;#i=!1;#n=null;#o=null;constructor({onComplete:t=null,onReset:e=null,format:i="seconds"}={}){super(),this.#n=t,this.#o=e,this.format=i}start(t){if(!t||t<=0)throw new Error("Duration must be a positive number");if(this.#t!==null)throw new Error("Timer is already running");this.#s=t*1e3,this.#e=this.#s,this.#i=!1,this.#a()}stop(){this.#t&&(clearInterval(this.#t),this.#t=null),this.#e=0,this.#i=!1}reset(t=!1){const e=this.isRunning();this.#t&&(clearInterval(this.#t),this.#t=null),this.#e=this.#s,this.#i=!1,this.#o&&this.#o(this.#s/1e3),(t||e)&&this.#a()}pause(){this.#t&&!this.#i&&(clearInterval(this.#t),this.#t=null,this.#i=!0)}resume(){this.#i&&(this.#i=!1,this.#a())}getTimeRemaining(){return Math.ceil(this.#e/1e3)}getInitialDuration(){return this.#s/1e3}isRunning(){return this.#t!==null&&!this.#i}#a(){this.#t=setInterval(()=>{if(!this.#i){this.#e=Math.max(0,this.#e-100);const t=Math.ceil(this.#e/1e3);this.emit("tick",t),this.#e<=0&&(this.stop(),this.#n&&this.#n())}},100)}}class u extends r{constructor(t,e){super(t,e),this.timer=new f({onComplete:()=>{this.element.style.transition="opacity 0.5s ease-out",this.element.style.opacity="0",setTimeout(()=>this.emit("close",this),500)},format:"seconds"}),this.timer.on("tick",a=>this.updateTitleBarDisplay(a));const i=document.createElement("div");i.style.cssText=`
      display: flex;
      flex-direction: column;
    ...
    `,s.textContent=this.getAppropriateIcon(content.type);const n=document.createElement("div");n.style.cssText=`
      ...
      margin-bottom: 10px;
      line-height: 1.5;
    `,n.innerHTML=this.content,i.appendChild(s),i.appendChild(n),this.contentArea.appendChild(i),this.element.appendChild(this.contentArea),this.timer.start(15)}getAppropriateIcon(t){return t.toLowerCase()==="win"?"🏆":t.toLowerCase()==="time"?"⏰":t.toLowerCase()==="star"?"🌟":t.toLowerCase()==="warning"?"⚠️":"ℹ️"}updateTitleBarDisplay(t){this.titletextdiv=this.titleBar.getElementsByClassName("window-title-bar-text")[0],this.titletextdiv.textContent=`Closing in ${t}s`}}class w{constructor(t,e,i,s,n=null){this.element=document.createElement("div"),this.element.className="desktop-icon",this.image=document.createElement("img"),this.image.src=e,this.image.alt=t,this.label=document.createElement("span"),this.label.textContent=t,this.element.appendChild(this.image),this.element.appendChild(this.label),s&&this.element.addEventListener("dblclick",s),this.element.style.cssText=`
      position: absolute;
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    `,this.label.style.cssText=`
      ...
      max-width: 76px;
    `}setPosition(t,e){this.element.style.left=`${t}px`,this.element.style.top=`${e}px`}}class b{constructor(t=!1){this.windows=new Map,this.icons=new Map,this.zIndexBase=1e3,this.username="Anonymous-"+Math.floor(Math.random()*1e3),this.background_color="#FAF9F6",this.taskbar_background_color="#c0c0c0",this.taskbar_text_color="#fff",this.windowTypes=new Map([[r.name,{width:600,height:400,icon:"",title:"Window",content:"",styles:{},events:{},savedstate:{}}],[x.name,{width:600,height:400,icon:"",title:"Chat",channel:"general",username:"Anonymous",content:"",styles:{},events:{toggleEmojis:()=>this.toggleEmojis(window),usernameChanged:s=>{this.username=s}},savedstate:{}}],[u.name,{width:300,height:200,icon:"",title:"Popup",content:"",styles:{},events:{},savedstate:{}}],[p.name,{width:300,height:400,icon:"",title:"Emojis",content:"",styles:{},events:{},savedstate:{}}]]);const e=document.createElement("link");e.href="https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500&display=swap",e.rel="stylesheet",document.head.appendChild(e),this.environment=document.createElement("div"),this.environment.id="window-environment",this.environment.style.cssText=`
      height: 100vh;
      width: 100vw;
      overflow-x: hidden;
      overflow-y: hidden;
    ...
    `,this.leftScrollButton.addEventListener("click",()=>this.scroll(-200)),this.taskbar.appendChild(this.leftScrollButton),this.taskbarScrollContainer=document.createElement("div"),this.taskbarScrollContainer.id="taskbar-scroll-container",this.taskbarScrollContainer.style.display="flex",this.taskbarScrollContainer.style.overflowX="hidden",this.taskbarScrollContainer.style.flexGrow=1,this.taskbarScrollContainer.style.height="25px",this.taskbarScrollContainer.style.minWidth="0",this.taskbarScrollContainer.style.maxWidth="40vw",this.taskbarScrollContainer.style.boxShadow="rgb(255, 255, 255) -1px -1px inset, rgb(0, 0, 0) 1px 1px inset, rgb(128, 128, 128) -2px -2px inset, rgb(223, 223, 223) 2px 2px inset",this.taskbarScrollContainer.style.alignItems="center",this.taskbarScrollContainer.style.padding="2px 5px",this.taskbar.appendChild(this.taskbarScrollContainer),this.rightScrollButton=document.createElement("button"),this.rightScrollButton.innerHTML="&#10095;",this.rightScrollButton.style.cssText=`
      ...
      margin-left: 5px;
      margin-right: auto;
    `,this.rightScrollButton.addEventListener("click",()=>this.scroll(200)),this.taskbar.appendChild(this.rightScrollButton),this.updateScrollButtons()}scroll(t){this.taskbarScrollContainer.scrollBy({left:t,behavior:"smooth"}),setTimeout(()=>this.updateScrollButtons(),50)}updateScrollButtons(){const t=this.taskbarScrollContainer,e=t.scrollLeft,i=t.scrollWidth,s=t.clientWidth;this.leftScrollButton.style.opacity=e>0?1:0,this.rightScrollButton.style.opacity=i>s&&e+s<i?1:0}addDefaultTaskbarIcons(){const t=this.createTaskbarIcon("Home",r,null);this.taskbar.appendChild(t);const e=this.createTaskbarIcon("Projects",r,null);this.taskbar.appendChild(e);const i=this.createTaskbarIcon("About Me",r,null);this.taskbar.appendChild(i);const s=this.createTaskbarIcon("Contact",r,null);this.taskbar.appendChild(s);const n=this.createTaskbarIcon("Source",r,null);this.taskbar.appendChild(n)}addIcon(t){const e=new w(t.title,t.image,t.onhover,()=>this.newWindow(t.type,t),t.timed);return e.setPosition(t.x,t.y),this.iconContainer.appendChild(e.element),this.icons.set(t.title,e),e}addDefaultIcons(){[{title:"Welcome",image:"images/clippy.gif",onhover:"images/clippy_closeup.gif",x:20,y:50,type:r,height:250,width:350,content:"<img src = 'images/clippy.gif'/>"},{title:"Current Projects",image:"icons/win_controls/console.png",onhover:"icons/win_controls/console.png",x:20,y:175,type:r,height:400,width:550,content:""},{title:"Music",image:"icons/win_controls/music.png",onhover:"icons/win_controls/music.png",x:20,y:300,type:r,height:400,width:550,content:""}].forEach(e=>{this.addIcon(e)})}createTaskbarIcon(t,e,i){const s=document.createElement("button");return s.className="taskbar-item",s.style.padding="0 10px",s.style.cursor="pointer",s.whiteSpace="nowrap",s.style.display="flex",s.style.alignItems="center",s.style.fontSize="14px",s.style.whiteSpace="nowrap",s.style.minWidth="20px",s.style.textOverflow="ellipsis",s.style.overflow="hidden",s.textContent=t,s.onclick=()=>this.newWindow(e,i||this.windowTypes.get(e.name)),s}pinWindow(t){const e=document.createElement("button");e.className="taskbar-item",e.style.padding="0 10px",e.style.cursor="pointer",e.whiteSpace="nowrap",e.style.display="flex",e.style.alignItems="center",e.style.fontSize="14px",e.style.whiteSpace="nowrap",e.style.minWidth="20px",e.style.textOverflow="ellipsis",e.style.overflow="hidden",e.textContent=t.title,e.onclick=()=>t.toggleMinimize(),this.taskbarScrollContainer.appendChild(e),this.icons.set(t.id,e),this.updateScrollButtons()}removeWindow(t){console.log("Removing window:",t.id),this.windows.has(t.id)&&(this.windows.delete(t.id),this.environment.removeChild(t.element),this.taskbarScrollContainer.removeChild(this.icons.get(t.id)),this.icons.delete(t.id),t.destroy(),this.updateZIndices(),this.saveState(),this.updateScrollButtons())}newWindow(t=r,e={}){const i=this.createWindow(crypto.randomUUID(),t,e);this.pinWindow(i),this.bringToFront(i),this.updateZIndices(),this.saveState()}createWindow(t,e=r,i={}){if(this.windows.has(t))return console.error(`Window with id ${t} already exists. Skipping creation.`),this.windows.get(t);if(!this.windowTypes.has(e.name))console.error(`${e.name} class not registered in windowTypes`),e.prototype instanceof r?(console.warn("Window class is a subclass of Window - Registering new Type"),this.windowTypes.set(e,{width:i.width||600,height:i.height||400,title:i.title||"",icon:i.icon||"",styles:i.styles||{},events:i.events||{},savedstate:i.savedstate||{}})):(console.error("Window class is not a subclass of Window - Using default Window class."),e=r);else{const n=this.windowTypes.get(e.name);for(const o in n)i[o]=i[o]||n[o]}const s=new e(t,i);return Object.entries(i.events).forEach(([n,o])=>{s.on(n,o)}),s.on("close",n=>this.removeWindow(n)),s.on("focus",n=>this.bringToFront(n)),s.on("dragStart",()=>this.startDragging(s)),s.on("minimize",()=>this.saveState()),s.on("drag",()=>this.saveState()),s.on("dragEnd",()=>this.saveState()),s.on("popup",n=>this.newWindow(`${crypto.randomUUID()}-${t}`,n,u)),this.windows.set(s.id,s),this.environment.appendChild(s.element),this.updateZIndices(),this.saveState(),s}toggleEmojis(t){t.emojiSelector?(t.emojiSelector.emit("close"),t.emojiSelector=null):(t.emojiSelector=this.createWindow(`emoji-${this.id}`,"","",300,400,null,p),t.initEmojiSelector(),this.bringToFront(t.emojiSelector))}bringToFront(t){const e=Array.from(this.windows.values()),i=e.indexOf(t);i!==-1&&(e.splice(i,1),e.push(t),this.windows.clear(),e.forEach(s=>this.windows.set(s.id,s)),this.updateZIndices(),this.saveState())}updateZIndices(){let t=0;this.windows.forEach(e=>{e.setZIndex(this.zIndexBase+t),t++})}startDragging(t){this.currentlyDragging=t,this.bringToFront(t)}onMouseMove(t){this.currentlyDragging&&this.currentlyDragging.drag(t)}onMouseUp(t){this.currentlyDragging&&(this.currentlyDragging.dragEnd(t),this.currentlyDragging=null)}saveState(){const t={windows:Array.from(this.windows.values()).map(e=>({...e.getState(),className:e.constructor.name}))};localStorage.setItem("windowEnvironmentState",JSON.stringify(t))}async restoreState(){try{const t=localStorage.getItem("windowEnvironmentState");if(t){const e=JSON.parse(t);for(const i of e.windows){const s=i.className;this.createWindow(i.id,i.title,i.content,i.width,i.height,i,s)}}}catch(t){console.error("Error restoring window state:",t)}}clearSavedState(){localStorage.removeItem("windowEnvironmentState")}}localStorage.removeItem("windowEnvironmentState");const v=new b(!0);v.clearSavedState();
